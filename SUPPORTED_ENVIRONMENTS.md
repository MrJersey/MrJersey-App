...
Other compatible static web hosting providers

Hosting providers are deployment infrastructure.

They do not define the BASE Creator System.
...
Those services operate independently of the BASE Creator System and remain subject to their own functionality, availability, and policies.

The BASE Creator System does not control the operation of third-party services.

Portability

Creator Deployments may be migrated between compatible hosting providers without changing the identity of the BASE Creator System.

Deployment portability remains a core design objective of the BASE Creator System.
